...
//テキストスタイル
const lanobeLargeTitleTextStyle = TextStyle(fontSize: 52, color: mainColor, fontFamily: Lanobe);
const lanobeMediumTextStyle = TextStyle(fontSize: 16, color: Colors.white, fontFamily: Lanobe);
const lanobeQuestionTextStyle = TextStyle(fontSize: 16, color: Colors.black87, fontFamily: Lanobe);
const lanobeAnswerTextStyle = TextStyle(fontSize: 16, fontFamily: Lanobe, color: redColor);
const AnswerTextStyle = TextStyle(fontSize: 28, fontFamily: Lanobe, color: Colors.white);
